...
- Date: 2026-06-14T15:07:23+0800
- Tool: Vivado 2021.2
- Top module: `requant_activation_unit`
...
| Metric | Value |
| --- | ---: |
| LUT primitive cells | 582 |
| FF/latch primitive cells | 294 |
...
- `build/reports/vivado_requant_activation_unit/utilization_hierarchical.txt`
- `build/reports/vivado_requant_activation_unit/timing_summary.txt`
- `build/reports/vivado_requant_activation_unit/clock_utilization.txt`
- `build/reports/vivado_requant_activation_unit/requant_activation_unit_synth.dcp` if checkpoint write passed
